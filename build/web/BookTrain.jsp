  ...
  <script>
        ...
        function chkfield(id)
            ...
            if(id=="adult")
              ...
              {
                   var a;
                  a=document.getElementById("trainno").value;
                  if(a.length==0 || isNaN(a) )
                    { 
                        document.getElementById("trainnoerr").innerHTML="<font color=red>Blank field</font>";
                        trainno_flag=false;
                    }
                   else
                   {
                       document.getElementById("trainnoerr").innerHTML="";
                       trainno_flag=true;
                   }   
              }
              if(id=="submit")
              {
                   document.getElementById(id).focus();
                    if(trainno_flag==false||pdate_flag==false||ddate_flag==false||cardno_flag==false||infant_flag==false||child_flag==false||adult_flag==false)
                  {
...
<!--==============================header=================================-->
 ...
 <div class="clear"></div>
  ...
  <div class="container_12" >
    <!--<div class="grid_4">-->
    <center><H2>Book Train</H2></center>
...
<td>&nbsp;</td>
  ...
  <tr>
    <td>Class Preference</td>
       <td><select name="tclass" id="tclass">
<option value="allclass" selected>All Class</option>
...
<option value="acchaircar">AC Chair Car</option>
  ...
  <tr>
    <td> Train No.</td>
    <td><input type="text" name="trainno" value="" id="trainno" onblur="chkfield(this.id)" onclick="enable()" /><div id="trainnoerr"></div></td>
    <td>&nbsp;</td>
  </tr>
  <tr><td>&nbsp;</td></tr> 
