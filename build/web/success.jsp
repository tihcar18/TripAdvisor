<%-- 
    Document   : success
    Created on : 16-Apr-2015, 22:37:19
    Author     : win 8
--%>
     ...
     <div class="container_12">
        ...
        <nav class="horizontal-nav full-width horizontalNav-notprocessed">
            <ul class="sf-menu">
                   ...
                   <li><a href="#"></a></li>
                   <li><a href="#"></a></li>
                   <li class="current"><a href="#">Success</a></li>
                 </ul>
              </nav>
 ...
 <div class="clear"></div>
  ...
  <div class="container_12" >
      ...
      <center> <h2>Payment Successful!</h2>
          <h2 style='font-size: 25px;color: black;'>  Thanks for using<br> Trip Advisor<br> </h2>
          <h2> You'll be redirected to Homepage in 5 secs!!</h2><br>
       </center>
