        ...
        function chkfield(id)
            {
              ...
              {
                   var a;
                  a=document.getElementById("noofrooms").value;
                  if(a.length==0 || isNaN(a) )
                    { 
                        document.getElementById("noofroomserr").innerHTML="<font color=red>Blank field</font>";
                        noofrooms_flag=false;
                    }
                   else
                   {
              ...
              if(id=="submit")
              {
                   document.getElementById(id).focus();
                    if(noofrooms_flag==false||pdate_flag==false||ddate_flag==false||cardno_flag==false||adult_flag==false||child_flag==false||infant_flag==false)
                  {
...
<!--==============================header=================================-->
 ...
 <div class="clear"></div>
  ...
  <div class="container_12" >
    <!--<div class="grid_4">-->
    <center><H2>Book Hotel</H2></center>
  ...
  <tr>
    ...
    <td><select name="accomo" id="accomo" >
                                 <option value="GH" selected="">Guest house</option>
...
<option value="DH">Dehradun</option>
  ...
  <tr>
    <td>No. Of Rooms</td>
    <td><input type="text" name="noofrooms" value="" id="noofrooms" onblur="chkfield(this.id)" onclick="enable()" /><div id="noofroomserr"></div></td>
    <td>&nbsp;</td>
  </tr>
  <tr><td>&nbsp;</td></tr> 
  <tr>
 ...
 <tr>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><div id="flddiv"></div><input type="submit" value="Book Hotel" id="submit" onmouseover="chkfield(this.id)" /></td>
  </tr>
        </table>
      </form>
  </div>
